...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，这是一个人工智能的学习频道，分享：AI以及前沿科技的干货内容,欢迎来到AI时代🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '清华哥', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '知识顶流MCN创始人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jiehe.tech', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI知识库, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jiehe_01@163.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  // 樱花飘落特效
  SAKURA: process.env.NEXT_PUBLIC_SAKURA || true, // 开关 false
  // 漂浮线段特效
  ...
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || 'BWos8pCv0R1Y6abZ0HcHM',//null
